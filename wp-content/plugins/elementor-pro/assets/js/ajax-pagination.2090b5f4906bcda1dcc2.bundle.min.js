        ...
        4734: (e, t, n) => {
            ...
            class AjaxPagination extends elementorModules.frontend.handlers.Base {
                ...
                afterInsertPosts() {
                    ...
                    elementorFrontend.elementsHandler.runReadyTrigger(this.$element[0]), (0, r.default)(t), ElementorProFrontendConfig.settings.lazy_load_background_images && document.dispatchEvent(new Event("elementor/lazyload/observe"))
                }
                onInit() {
